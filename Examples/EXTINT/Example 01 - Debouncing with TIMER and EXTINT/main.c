...
void vToggleLEDInterrupt(void* vpArgs){
  vDisableEXTINT(EXTINT_0);                                                     //Disabling external interruption on PINE4.
...
void vDebouncingButton(void* vpArgs){
  vIgnoreEXTINTRequest(EXTINT_0);                                               //Ignoring all external interrutions on PINE4 while EXTINT_4 is disabled.
  vEnableEXTINT(EXTINT_0);                                                      //Enabling external interruption on PINE4.
